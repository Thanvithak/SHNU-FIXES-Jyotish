...
public class ResultColumn {
    ...
    public ResultColumn(ResultSet resultSet, TResultColumn resultColumnObject) {
        ...
        } else {//FIX I4 exchanged the if above and below
            if (resultColumnObject.getExpr().getExpressionType() == EExpressionType.sqlserver_proprietary_column_alias_t) {
                ...
                this.name = this.alias;
            } else if (resultColumnObject.getExpr().getExpressionType() != EExpressionType.simple_object_name_t) {

                if (resultSet instanceof SelectResultSet) {//Fix 7  for Expression coming as columnName
                    this.name = "DUMMY"
